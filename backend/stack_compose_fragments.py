...
def _render_nessie_fragment(env: dict) -> str:
    ...
    return (
        ...
        "      NESSIE_CATALOG_SERVICE_S3_DEFAULT_OPTIONS_ACCESS_KEY: urn:nessie-secret:quarkus:nessie-s3-creds\n"
        "      NESSIE_CATALOG_SERVICE_S3_DEFAULT_OPTIONS_AUTH_TYPE: STATIC\n"
        "      NESSIE_CATALOG_SECRETS_NESSIE_S3_CREDS_NAME: admin\n"
        "      NESSIE_CATALOG_SECRETS_NESSIE_S3_CREDS_SECRET: udp_admin_12345\n"
        "    ports:\n"
        "      - \"19120:19120\"\n"
        "    healthcheck:\n"
